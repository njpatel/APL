...
namespace APL.Language.Parsing
{
    ...
    /// <summary>
    /// Parsers for the APL query grammar.
    /// </summary>
        ...
        private void Initialize()
        {
            ...
            var ScanAnyQueryOperatorParameterName =
                Or(
                    ...
                    Or(APLFacts.KnownQueryOperatorParameterNames.Select(n => MatchText(n)).ToArray()));
            ...
            var KnownQueryOperatorParameter =
                First(
                    DeclaredQueryOperatorParameter,
                    QParameter(
                        HiddenToken(APLFacts.KnownQueryOperatorParameterNames),
                        AnyQueryOperatorParameterValue));
            ...
            Parser<LexicalToken, DataScopeClause> DataScopeClause(CompletionKind ckind) =>
                Rule(
                    ...
                    RequiredToken(SyntaxKind.EqualToken),
                    RequiredToken(APLFacts.DataScopeValues),
            ...
            var TakeOperator =
                Rule(
                    ...
                    Required(NamedExpression.Examples(APLFacts.LimitExamples), MissingExpression),
            ...
            var TopHittersOperator =
                Rule(
                    ...
                    Required(NamedExpression.Examples(APLFacts.TopExamples), MissingExpression),
                    RequiredToken(SyntaxKind.OfKeyword),
                    Required(NamedExpression, MissingExpression),
            ...
            var RenderChartType =
                First(
                    First(APLFacts.ChartTypes.Select(c => APLFacts.HiddenChartTypes.Contains(c) ? Token(c).Hide() : Token(c, CompletionKind.RenderChart)).ToArray()),
            ...
            var RenderOperator =
                Rule(
                    ...
                    Required(RenderChartType, () => CreateMissingToken(APLFacts.ChartTypes)),
