...
namespace APL.Language.Parsing
{
    ...
    /// <summary>
    /// Parsers for the APL command grammar.
    /// </summary>
            ...
            Parser<LexicalToken, Command> command)
        {
            ...
            var grammar = GrammarGrammar.CreateParser(
                getRule: name => {
                    switch (name)
                    {
                        case "value": return APLValueInfo;
                        case "timespan": return APLValueInfo;
                        case "datetime": return APLValueInfo;
                        case "string": return APLStringLiteralInfo;
                        case "bool": return APLValueInfo;
                        case "long": return APLValueInfo;
                        case "int": return APLValueInfo;
                        case "decimal": return APLValueInfo;
                        case "real": return APLValueInfo;
                        case "type": return APLTypeInfo;
                        case "guid": return APLGuidLiteralInfo;
                        case "name": return APLNameDeclarationInfo;
                        case "column": return APLColumnNameInfo;
                        case "table_column": return APLTableColumnNameInfo;
                        case "database_table_column": return APLDatabaseTableColumnNameInfo;
                        case "table": return APLTableNameInfo;
                        case "externaltable": return APLExternalTableNameInfo;
                        case "materializedview": return APLMaterializedViewNameInfo;
                        case "database_table": return APLDatabaseTableNameInfo;
                        case "database": return APLDatabaseNameInfo;
                        case "cluster": return APLClusterNameInfo;
                        case "function": return APLFunctionNameInfo;
                        case "function_declaration": return APLFunctionDeclaration;
                        case "function_body": return APLFunctionBody;
                        case "input_query": return APLCommandInputInfo;
                        case "input_data": return APLInputText;
                        case "bracketed_input_data": return APLBracketedInputText;
                        default: return null;
                    }
                },
