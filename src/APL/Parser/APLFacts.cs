...
namespace APL.Language
{
    ...
    public static class APLFacts
    {
        ...
        private static readonly string APLWindowsNet = ".APL.windows.net";
        ...
        /// <summary>
        /// Returns true if the hostname ends with .APL.windows.net.
        /// </summary>
        public static bool IsAPLWindowsNet(string hostname)
        {
            return hostname.EndsWith(APLWindowsNet, StringComparison.OrdinalIgnoreCase);
        }
