...
namespace APL.Language
{
    ...
    /// <summary>
    /// A model of a APL code block, with the breakdown of its syntax, diagnostics and referenced symbols.
    /// </summary>
    public sealed class APLCode
    {
        /// <summary>
        ...
        /// <summary>
        /// Create a new <see cref="APLCode"/> instance from the text and globals. Does not perform semantic analysis.
        /// </summary>
        ...
        public static APLCode Parse(string text, GlobalState globals = null)
        {
            if (text == null)
        ...
        /// <summary>
        /// Create a new <see cref="APLCode"/> instance from the text and globals and performs semantic analysis.
        /// </summary>
        /// <param name="text">The code text</param>
        /// <param name="globals">The globals to use for parsing and semantic analysis. Defaults to <see cref="GlobalState.Default"/></param>.
        /// <param name="cancellationToken">A <see cref="CancellationToken"/> that can be used to cancel parsing and semantic analysis.</param>
        public static APLCode ParseAndAnalyze(string text, GlobalState globals = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (text == null)
                throw new ArgumentNullException(nameof(text));
        ...
        /// <summary>
        /// Creates a new <see cref="APLCode"/> form the already parsed lexical tokens.
        /// </summary>
        private static APLCode Create(string text, GlobalState globals, LexicalToken[] tokens, List<int> tokenStarts, bool analyze, CancellationToken cancellationToken)
        {
            Parser<LexicalToken> grammar;
            SyntaxNode syntax;
            ...
            return new APLCode(text, kind, globals, grammar, tree, analyzed, resultType, tokens, tokenStarts, localCache);
        }
        ...
        /// <summary>
        /// Returns a new <see cref="APLCode"/> with semantic analysis performed
        /// or the current instance if semantic analysis has already been performed.
        /// </summary>
        public APLCode Analyze(GlobalState globals = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            if (globals == null)
            {
        ...
        /// <summary>
        /// Creates a new instance of <see cref="APLCode"/> with the specified <see cref="GlobalState"/>
        /// </summary>
        public APLCode WithGlobals(GlobalState globals, CancellationToken cancellationToken = default(CancellationToken))
        {
