...
namespace APL.Language
{
    ...
    public static class QueryOperatorParameters
    {
        public static readonly QueryOperatorParameter BagExpansion =
            new QueryOperatorParameter("bagexpansion", QueryOperatorParameterValueKind.Word, values: APLFacts.MvExpandKinds).Hide();
        ...
        public static readonly QueryOperatorParameter HintDotConcurrency =
            new QueryOperatorParameter("hint.concurrency", QueryOperatorParameterValueKind.WordOrNumber, values: APLFacts.JoinHintRemotes);

        public static readonly QueryOperatorParameter HintDotDistribution =
            new QueryOperatorParameter("hint.distribution", QueryOperatorParameterValueKind.Word, values: APLFacts.DistributionHintStrategies);
        ...
        public static readonly QueryOperatorParameter HintDotRemote =
            new QueryOperatorParameter("hint.remote", QueryOperatorParameterValueKind.Word, values: APLFacts.JoinHintRemotes);
        ...
        public static readonly QueryOperatorParameter HintDotSpread =
            new QueryOperatorParameter("hint.spread", QueryOperatorParameterValueKind.WordOrNumber, values: APLFacts.JoinHintRemotes);

        public static readonly QueryOperatorParameter HintDotStrategy =
            new QueryOperatorParameter("hint.strategy", QueryOperatorParameterValueKind.Word, values: APLFacts.JoinHintStrategies);
        ...
        {
            HintDotShuffleKey,
            HintDotStrategy.WithValues(APLFacts.SummarizeHintStrategies),
        ...
        {
            Kind.WithValues(APLFacts.JoinKinds),
            HintDotRemote.WithValues(APLFacts.JoinHintRemotes),
            HintDotShuffleKey,
            HintDotStrategy.WithValues(APLFacts.JoinHintStrategies),
            HintDotNumPartitions
        }.ToReadOnly();
        ...
        {
            Kind.WithValues(APLFacts.MvExpandKinds),
            BagExpansion.WithValues(APLFacts.MvExpandKinds).Hide(),
            WithItemIndex,
        }.ToReadOnly();

        public static readonly IReadOnlyList<QueryOperatorParameter> ParseParameters = new QueryOperatorParameter[]
        {
            Kind.WithValues(APLFacts.ParseKinds),
            Flags,
        }.ToReadOnly();
        ...
        public static readonly QueryOperatorParameter RenderKind =
            new QueryOperatorParameter("kind", QueryOperatorParameterValueKind.Word, values: APLFacts.ChartKinds);
        ...
        public static readonly IReadOnlyList<QueryOperatorParameter> RenderWithProperties = new QueryOperatorParameter[]
        {
            ...
            new QueryOperatorParameter("xaxis", QueryOperatorParameterValueKind.Word, values: APLFacts.ChartAxis),
            new QueryOperatorParameter("yaxis", QueryOperatorParameterValueKind.Word, values: APLFacts.ChartAxis),
            new QueryOperatorParameter("legend", QueryOperatorParameterValueKind.Word, values: APLFacts.ChartLegends),
            new QueryOperatorParameter("ysplit", QueryOperatorParameterValueKind.Word, values: APLFacts.ChartYSplit),
        ...
        {
            HintDotStrategy.WithValues(APLFacts.OrderByHintStrategies)
        }.ToReadOnly();
