...
namespace APL.Language.Editor
{
    ...
    internal class APLCompleter
    {
        private readonly APLCode code;
        ...
        private CompletionItem GetSymbolCompletionItem(Symbol symbol, SyntaxNode contextNode, bool nameOnly)
        {
            ...
            string editName = APLFacts.BracketNameIfNecessary(symbol.Name);
            ...
            switch (symbol)
            {
                ...
                case ClusterSymbol cl:
                    return new CompletionItem(CompletionKind.Cluster, cl.Name, APLFacts.GetBracketedName(cl.Name));
        ...
        private CompletionMode GetSetOptionCompletions(int position, SyntaxNode contextNode, int childIndex, CompletionBuilder builder)
        {
                ...
                && option.Examples != null)
            {
                ...
                {
                    var value = APLFacts.GetStringLiteralValue(example);
        ...
        {
            return symbols.Select(s => new CompletionItem(CompletionKind.Example, APLFacts.GetStringLiteral(s.Name)));
        }
