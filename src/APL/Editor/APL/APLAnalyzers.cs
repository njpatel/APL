...
namespace APL.Language.Editor
{
    ...
    /// </summary>
    public static class APLAnalyzers
    {
        public static readonly APLAnalyzer AvoidUsingContains = APLAnalyzer.Create(
            ...
            new Diagnostic(
                ...
                message: $"Avoid using the 'contains' operator as it has a high compute price." + Environment.NewLine +
                         $"Use the 'has' operator in cases when full term match is desired (see: https://aka.ms/APL.stringterms)."),
            (code, dx, diagnostics) =>
            {
        ...
        // KS501 & KS502
        public static readonly APLAnalyzer AvoidUsingIsNullStringComparison =
            new AvoidUsingIsNullStringComparisonAnalyzer();

        public static readonly APLAnalyzer AvoidUsingShortStringComparision = APLAnalyzer.Create(
            ...
            new Diagnostic(
                ...
                message: "Avoid using short strings (less than 4 characters) for string comparison operations (see: https://aka.ms/APL.stringterms)."),
            (code, dx, diagnostics) =>
            {
                foreach (var node in code.Syntax.GetDescendants<BinaryExpression>())
                {
        ...
        public static readonly APLAnalyzer AvoidUsingToBoolOnNumerics = APLAnalyzer.Create(
        ...
        public static readonly APLAnalyzer NullAggregation = APLAnalyzer.Create(
        ...
        public static readonly APLAnalyzer AvoidUsingFormatDatetimeInPredicate = APLAnalyzer.Create(
        ...
        public static readonly APLAnalyzer AvoidUsingObsoleteFunctions = APLAnalyzer.Create(
        ...
        public static readonly APLAnalyzer AvoidJoinWithoutKind = APLAnalyzer.Create(
        ...
        public static readonly APLAnalyzer StdevTimespanConversion = APLAnalyzer.Create(
        ...
        public static IReadOnlyList<APLAnalyzer> All =
             new APLAnalyzer[]
             {
                 AvoidUsingContains,
    ...
    /// </summary>
    internal class AvoidUsingIsNullStringComparisonAnalyzer : APLAnalyzer
    {
