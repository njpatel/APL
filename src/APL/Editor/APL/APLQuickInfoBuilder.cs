...
namespace APL.Language.Editor
{
    ...
    internal class APLQuickInfoBuilder
    {
        private readonly APLCodeService _service;
        private readonly APLCode _code;
        private readonly QuickInfoOptions _options;
        private readonly DisabledDiagnostics _disabled;

        public APLQuickInfoBuilder(APLCodeService service, APLCode code, QuickInfoOptions options)
        {
            _service = service;
            _code = code;
            _options = options;
