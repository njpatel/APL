...
namespace APL.Language.Editor
{
    ...
    internal class APLFormatter
    {
        ...
        internal APLFormatter(int cursorPosition, FormattingOptions options)
        {
        ...
        {
            var formatter = new APLFormatter(cursorPosition, options ?? FormattingOptions.Default);
