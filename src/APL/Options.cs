...
namespace APL.Language
{
    ...
    public class Options
    {
        ...
        public static readonly OptionSymbol ProgressiveProgressReportPeriod =
            new OptionSymbol("query_results_progressive_update_period", "Hint for APL as to how often to send progress frames (takes effect only if OptionResultsProgressiveEnabled is set)");

        public static readonly OptionSymbol ProgressiveQueryMinRowCountPerUpdate =
            new OptionSymbol("query_results_progressive_row_count", "Hint for APL as to how many records to send in each update (takes effect only if OptionResultsProgressiveEnabled is set)");
        ...
        public static readonly OptionSymbol QueryResultsCacheMaxAge =
            new OptionSymbol("query_results_cache_max_age", "If positive, controls the maximum age of the cached query results which APL is allowed to return", ScalarTypes.TimeSpan);
