...
using CompletionKind=APL.Language.Editor.CompletionKind;
using CompletionHint=APL.Language.Editor.CompletionHint;
...
namespace APL.Language.Syntax
{
    ...
    /// <summary>
    /// A node in the APL syntax that represents an expression
    /// </summary>
    ...
    #region class Clause
    /// <summary>
    /// A node in the APL syntax that represents a clause
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a typeof expression
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a query operator
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a statement.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that name expression.
    /// </summary>
    ...
    #region class Name
    /// <summary>
    /// A node in the APL syntax that represents a name.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a single identifier name.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a bracketed name.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a client parameter.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a name declaration.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a name reference.
    /// </summary>
    public sealed partial class NameReference : Expression
    {
        ...
        public APL.Language.Symbols.SymbolMatch Match { get; }
        
        /// <summary>
        /// Constructs a new instance of <see cref="NameReference"/>.
        /// </summary>
        internal NameReference(Name name, APL.Language.Symbols.SymbolMatch match, IReadOnlyList<Diagnostic> diagnostics = null) : base(diagnostics)
        {
            this.Name = Attach(name);
            this.Match = match;
            this.Init();
    ...
    /// <summary>
    /// A node in the APL syntax that represents a literal expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents an expression comprised of a single token.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a json expression
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a JSON scalar expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a JSON object expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a JSON array expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a dynamic expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a parenthesized expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a parenthesized list of expressions.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a parenthesized pair of expressions.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a prefix unary expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a binary expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents an in expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a has_any expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a has_all expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a between expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a function call expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents the toscalar operation.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents the totable operation.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents the materilized-view-combine expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents the materilized-view-combine view name part.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents the materilized-view-combine clause.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a named expression.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a parenthesized list of names.
    /// </summary>
    ...
    /// <summary>
    /// A node in the APL syntax that represents a compound named expression.
    /// </summary>
