...
#if APL_BUILD
namespace APL.Language.Generator
{
    using System;
...
#pragma warning disable CS0649
    ...
    /// <summary>
    /// Design-time description of a node in the CSL tree (something that derives APL.DataNode.Csl.CslNode).
    /// </summary>
    ...
    /// classes that derive APL.DataNode.Csl.CslNode.
    /// </summary>
    internal class CslTreeGenerator
    {
            ...
            )
        {
            ...
            eg.WriteFileStart();
            eg.m_writer.WriteNamespaceDeclaration("APL.Language.Syntax", eg.WriteClasses);
            eg.WriteFileEnd();
        ...
        private void WriteFileStart()
        {
            ...
            var ns = new List<string>
            {
                ...
                "CompletionKind=APL.Language.Editor.CompletionKind",
                "CompletionHint=APL.Language.Editor.CompletionHint"
            };
